...
Dự án tập trung vào bài toán **xếp hạng tín dụng doanh nghiệp (corporate credit rating)** dựa trên dữ liệu tài chính theo thời gian.
...
- Cải thiện dự báo theo bản chất thứ bậc (ordinal) của nhãn xếp hạng tín dụng doanh nghiệp.
...
2. Chuẩn hóa nhãn xếp hạng tín dụng doanh nghiệp:
...
|---|---|---|---|
| `rating_detail` | Categorical | Nhãn mục tiêu 3 nhóm rủi ro tín dụng doanh nghiệp: `IG`, `HY`, `Distressed`. | Đây là target trong thiết lập 3 lớp (ordinal thô theo mức rủi ro tăng dần: `IG -> HY -> Distressed`). |
...
| `rating_agency` | Categorical | Tổ chức đánh giá xếp hạng tín dụng (Moody's, S&P, Fitch, EJR, ...). | Có thể chứa khác biệt phong cách chấm điểm giữa agency; thường encode để mô hình hấp thụ hiệu ứng hệ thống. |
...
| Thuộc tính | Ý nghĩa tài chính | Diễn giải rủi ro tín dụng doanh nghiệp (xu hướng chung) |
|---|---|---|
...
| `debt_equity_ratio` | Tổng nợ / vốn chủ sở hữu, phản ánh mức đòn bẩy tài chính. | Cao kéo dài thường làm tăng rủi ro tín dụng doanh nghiệp; giá trị âm có thể xuất hiện khi vốn chủ âm, là cảnh báo cấu trúc vốn bất thường. |
...
| `net_profit_margin` | Biên lợi nhuận ròng. | Kết quả cuối cùng sau mọi chi phí; âm kéo dài liên quan khả năng suy giảm xếp hạng tín dụng. |
...
- `Distressed`: nhóm căng thẳng tài chính cao, xác suất suy giảm xếp hạng tín dụng/vỡ nợ lớn hơn.
...
- CORN chuyển bài toán K lớp ordinal thành K-1 bài toán nhị phân có điều kiện, phù hợp bản chất xếp hạng tín dụng doanh nghiệp.
...
Dự án xây dựng một hệ thống dự báo xếp hạng tín dụng doanh nghiệp theo hướng:
