...
\begin{table}[H] \centering \caption{Kết quả GradientSHAP của các kịch bản trên tập kiểm thử} \label{tab:gradientshap_results} \renewcommand{\arraystretch}{0.85} \setlength{\tabcolsep}{2pt} \begin{tabular}{|>{\centering\arraybackslash}m{0.47\textwidth}| >{\centering\arraybackslash}m{0.47\textwidth}|} \hline \textbf{Kết quả GradientSHAP của kịch bản 1} & \textbf{Kết quả GradientSHAP của kịch bản 2} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-lightgbm.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-xgboost.png} \\ \hline \textbf{Kết quả GradientSHAP của kịch bản 3} & \textbf{Kết quả GradientSHAP của kịch bản 4} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-tcn.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-lstm.png} \\ \hline \textbf{Kết quả GradientSHAP của kịch bản 5} & \textbf{Kết quả GradientSHAP của kịch bản 6} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-patchtst.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-tlstm.png} \\ \hline \textbf{Kết quả GradientSHAP của kịch bản 7} & \textbf{Kết quả GradientSHAP của kịch bản 8} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-graph.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-fittx.png} \\ \hline \textbf{Kết quả GradientSHAP của kịch bản 9} & \textbf{Kết quả GradientSHAP của kịch bản 10} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-fipll.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-fittlpxl.png} \\ \hline \textbf{Kết quả GradientSHAP của kịch bản 11} & \textbf{Kết quả GradientSHAP của kịch bản 12} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-frttx.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-frpll.png} \\ \hline \textbf{Kết quả GradientSHAP của kịch bản 13} & \textbf{Kết quả GradientSHAP của kịch bản 14} \\ \includegraphics[width=0.55\linewidth]{acc-loss/shap-frttlpxl.png} & \includegraphics[width=0.55\linewidth]{acc-loss/shap-dmf.png} \\ \hline \end{tabular} \end{table}
...
\includegraphics[width=0.55\linewidth]{acc-loss/lime-tcn.png} & \includegraphics[width=0.55\linewidth]{acc-loss/lime-lstm.png} \\ 
\hline 
...
\includegraphics[width=0.55\linewidth]{acc-loss/lime-fipll.png} & \includegraphics[width=0.55\linewidth]{acc-loss/lime-ttlpxl.png} \\ 
\hline 
