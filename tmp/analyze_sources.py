...
print(f'- merged_credit_rating_common_3groups has: gross_profit_margin, operating_profit_margin, ebit_margin, pretax_profit_margin, operating_cashflow_ps, free_cashflow_ps')
print(f'- But it contains international companies, not Vietnamese')
