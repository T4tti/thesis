...
def build_explanation_prompt(
    ...
    if safe_lang == "vi":
        return (
            "Bạn là chuyên gia phân tích xếp hạng tín dụng doanh nghiệp. "
            "QUAN TRỌNG: Phản hồi bằng tiếng Việt có đầy đủ dấu câu và dấu thanh.\n"
            "Viết ngắn gọn, bám sát số liệu, không được tự ý bịa số liệu.\n\n"
            "YÊU CẦU ĐẦU RA:\n"
            "- Trả lời bằng 8-10 bullet (180-280 từ), không markdown phức tạp.\n"
            "- Cấu trúc 4 khối: (1) Tổng quan rủi ro 2 bullet; (2) Top-3 động lực 3 bullet; "
            "(3) Vị trí notch S&P và áp lực re-rating 2 bullet; (4) Hành động ưu tiên 2 bullet.\n"
...
def _build_prompt(
    ...
    if lang == "vi":
        return (
            "Bạn là chuyên gia phân tích xếp hạng tín dụng doanh nghiệp theo phong cách "
            "tổ chức xếp hạng quốc tế.\n"
            "QUAN TRỌNG: Luôn phản hồi bằng tiếng Việt có đầy đủ dấu câu và dấu thanh.\n\n"
            "NHIỆM VỤ: Chỉ tạo DUY NHẤT nội dung cho phần 'Risk Interpretation'.\n"
            "Ràng buộc bắt buộc:\n"
            "- Bắt buộc dựa trên CẢ HAI nguồn: kết quả dự đoán TLSTM và bộ xAI SHAP/có cấu trúc.\n"
            "- Không tạo section khác, không lặp lại tiêu đề, không markdown phức tạp.\n"
            "- Viết 8-12 bullet có chiều sâu, tổng 220-360 từ.\n"
            "- Nếu confidence thấp hoặc dữ liệu thiếu, phải nêu rõ mức độ bất định.\n"
            "- Bắt buộc chỉ ra tối thiểu 4 chỉ số tài chính then chốt và giải thích vì sao "
            "chúng đẩy hoặc hạ rủi ro.\n"
            "- Bắt buộc diễn giải theo thang S&P AAA-D ở dạng dải khả năng đạt được "
            "(không được khẳng định xếp hạng notch chính thức).\n"
            "- Có 4 phần logic trong chuỗi bullet: Tổng quan rủi ro, động lực SHAP theo "
            "chỉ số, dải S&P AAA-D có thể đạt, hành động ưu tiên.\n"
            "- Coi kết quả là tham khảo AI, không thay thế thẩm định chuyên sâu.\n\n"
            f"Dự đoán chính từ hệ thống:\n{primary_text}\n\n"
            f"Kết quả dự đoán TLSTM cần bám sát:\n{tlstm_text}\n\n"
            f"Bộ giải thích xAI (có cấu trúc):\n{xai_text}\n\n"
            f"Khung tham chiếu S&P AAA-D để diễn giải:\n{sp_context_text}\n\n"
            f"Tóm tắt kết quả nhanh:\n- rating: {rating}\n- confidence: {confidence_text}\n"
            f"- risk_score: {risk_score_text}\n- probabilities: {probs_text}\n\n"
            f"Dữ liệu tài chính đầu vào:\n{feature_lines}\n"
        )
            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "Never invent ratios, SHAP values, or model outputs not provided. "
