...
\setlength{\fairfigurewidth}{10cm}
...
\begin{figure}[H]
    ...
    \includegraphics[width=\textwidth]{uploads/sodo.drawio.drawio.png}
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=\fairfigurewidth]{uploads/train_val_accuracy_comparison.png}
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=\fairfigurewidth]{acc-loss/train_val_loss_comparison.png}
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=\fairfigurewidth]{acc-loss/time-train.png}
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=\fairfigurewidth]{acc-loss/test_accuracy_scenario_comparison.png}
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=\fairfigurewidth]{acc-loss/test_inference_time_comparison.png} % Thay 'ten-file-anh' bằng tên ảnh của bạn (không cần đuôi .png/.jpg)
