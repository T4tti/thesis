...
\newcommand{\xairesultcell}[3][0.55\linewidth]{%
...
14 & DMF & Dynamic Model Fusion & GraphSAGE + T-LSTM \\ \hline
\end{longtable}
\endgroup
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=0.9\textwidth]{uploads/train_val_accuracy_comparison.png}  
...
\hline
\xairesultcell[0.72\linewidth]{Kịch bản 1: LightGBM}{acc-loss/acc-lightgbm.png} &
\xairesultcell[0.72\linewidth]{Kịch bản 2: XGBoost}{acc-loss/acc-xgboost.png} \\
\hline
\xairesultcell[0.72\linewidth]{Kịch bản 3: TCN}{acc-loss/acc-tcn.png} &
\xairesultcell[0.72\linewidth]{Kịch bản 4: LSTM}{acc-loss/acc-lstm.png} \\
\hline
\xairesultcell[0.72\linewidth]{Kịch bản 5: PatchTST}{acc-loss/acc-patchtst.png} &
\xairesultcell[0.72\linewidth]{Kịch bản 6: T-LSTM}{acc-loss/acc-tlstm.png} \\
\hline
\xairesultcell[0.72\linewidth]{Kịch bản 7: GraphSAGE}{acc-loss/acc-graph.png} & \\
\hline
\end{longtable}
\endgroup
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=0.9\textwidth]{acc-loss/train_val_loss_comparison.png} 
...
\hline
\xairesultcell[0.75\linewidth]{Kịch bản 1: LightGBM}{acc-loss/loss-lightgbm.png} &
\xairesultcell[0.75\linewidth]{Kịch bản 2: XGBoost}{acc-loss/loss-xgboost.png} \\
\hline
\xairesultcell[0.75\linewidth]{Kịch bản 3: TCN}{acc-loss/loss-tcn.png} &
\xairesultcell[0.75\linewidth]{Kịch bản 4: LSTM}{acc-loss/loss-lstm.png} \\
\hline
\xairesultcell[0.75\linewidth]{Kịch bản 5: PatchTST}{acc-loss/loss-oatchtst.png} &
\xairesultcell[0.75\linewidth]{Kịch bản 6: T-LSTM}{acc-loss/loss-tlstm.png} \\
\hline
\xairesultcell[0.75\linewidth]{Kịch bản 7: GraphSAGE}{acc-loss/loss-graph.png} & \\
\hline
\end{longtable}
\endgroup
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=0.8\textwidth]{acc-loss/time-train.png} 
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=0.8\textwidth]{acc-loss/test_accuracy_scenario_comparison.png} 
...
\end{subfigure}
\caption[]{Precision lớp HY (b) (tiếp)}
\end{figure}
...
\end{subfigure}
\caption[]{Precision lớp IG (c) (tiếp)}
\end{figure}
...
\end{subfigure}
\caption[]{F1-score lớp HY (b) (tiếp)}
\end{figure}
...
\end{subfigure}
\caption[]{F1-score lớp IG (c) (tiếp)}
\end{figure}
...
\includegraphics[width=0.95\linewidth]{acc-loss/cm-dmf.png} & \\
\hline
\end{longtable}
\endgroup
...
\begin{figure}[H]
    \centering % Căn giữa hình ảnh
    \includegraphics[width=0.9\textwidth]{acc-loss/test_inference_time_comparison.png} % Thay 'ten-file-anh' bằng tên ảnh của bạn (không cần đuôi .png/.jpg)
...
\begin{longtable}{|>{\centering\arraybackslash}m{0.47\textwidth}|
                    >{\centering\arraybackslash}m{0.47\textwidth}|}
\caption{Kết quả GradientSHAP của các kịch bản trên tập kiểm thử}
\label{tab:gradientshap_results}\\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 1}{acc-loss/shap-lightgbm.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 2}{acc-loss/shap-xgboost.png} \\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 3}{acc-loss/shap-tcn.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 4}{acc-loss/shap-lstm.png} \\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 5}{acc-loss/shap-patchtst.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 6}{acc-loss/shap-tlstm.png} \\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 7}{acc-loss/shap-graph.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 8}{acc-loss/shap-fittx.png} \\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 9}{acc-loss/shap-fipll.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 10}{acc-loss/shap-fittlpxl.png} \\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 11}{acc-loss/shap-frttx.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 12}{acc-loss/shap-frpll.png} \\
\hline
\xairesultcell{Kết quả GradientSHAP của kịch bản 13}{acc-loss/shap-frttlpxl.png} &
\xairesultcell{Kết quả GradientSHAP của kịch bản 14}{acc-loss/shap-dmf.png} \\
\hline
\end{longtable}
\endgroup
...
\hline
\xairesultcell{Kết quả LIME của kịch bản 1}{acc-loss/lime-lightgbm.png} &
\xairesultcell{Kết quả LIME của kịch bản 2}{acc-loss/lime-xgboost.png} \\
\hline 
\xairesultcell{Kết quả LIME của kịch bản 3}{acc-loss/lime-tcn.png} &
\xairesultcell{Kết quả LIME của kịch bản 4}{acc-loss/lime-lstm.png} \\
\hline 
\xairesultcell{Kết quả LIME của kịch bản 5}{acc-loss/lime-patchtst.png} &
\xairesultcell{Kết quả LIME của kịch bản 6}{acc-loss/lime-tlstm.png} \\
\hline 
\xairesultcell{Kết quả LIME của kịch bản 7}{acc-loss/lime-graph.png} &
\xairesultcell{Kết quả LIME của kịch bản 8}{acc-loss/lime-fittx.png} \\
\hline 
\xairesultcell{Kết quả LIME của kịch bản 9}{acc-loss/lime-fipll.png} &
\xairesultcell{Kết quả LIME của kịch bản 10}{acc-loss/lime-ttlpxl.png} \\
\hline 
\xairesultcell{Kết quả LIME của kịch bản 11}{acc-loss/lime-frttx.png} &
\xairesultcell{Kết quả LIME của kịch bản 12}{acc-loss/lime-frpll.png} \\
\hline 
\xairesultcell{Kết quả LIME của kịch bản 13}{acc-loss/lime-frttlpxl.png} &
\xairesultcell{Kết quả LIME của kịch bản 14}{acc-loss/lime-dmf.png} \\
\hline 
\end{longtable}
\endgroup
...
Morthens \cite{morthens_credit_nodate}
...
Sanjiv Das và cộng sự \cite{noauthor_credit_nodate}
...
B. Chen và S. Long \cite{chen_novel_2020}
& People's Bank of China and Ji'an Rating
& SMAGRU
& 93.33\% \\

Feng và cộng sự \cite{feng_every_2020}
& Bộ dữ liệu xếp hạng doanh nghiệp niêm yết tại Trung Quốc
& CCR-GNN
& 95\% \\
...
\section{KẾT LUẬN}
Nghiên cứu này đã xây dựng hệ thống xếp hạng tín dụng doanh nghiệp dựa trên các mô hình máy học, học sâu và mô hình đồ thị. Dữ liệu đầu vào gồm các chỉ số tài chính phản ánh thanh khoản, đòn bẩy, khả năng sinh lời, hiệu quả hoạt động và dòng tiền của doanh nghiệp. Các mô hình như LightGBM, XGBoost, LSTM, TCN, PatchTST, T-LSTM và GraphSAGE được triển khai nhằm phân loại doanh nghiệp vào ba nhóm xếp hạng gồm Investment Grade (IG), High Yield (HY) và Distressed. Kết quả thực nghiệm cho thấy các mô hình đều đạt hiệu suất tương đối ổn định trên tập kiểm thử. Trong đó, phương pháp Dynamic Model Fusion (DMF), kết hợp T-LSTM và GraphSAGE, đạt kết quả tốt nhất với độ chính xác 92,98\%. Điều này cho thấy việc kết hợp mô hình chuỗi thời gian và mô hình đồ thị có khả năng cải thiện hiệu quả phân loại trong bài toán xếp hạng tín dụng doanh nghiệp. Bên cạnh hiệu suất dự báo, nghiên cứu còn tích hợp các kỹ thuật Explainable AI như GradientSHAP và LIME để giải thích quyết định của mô hình. Kết quả cho thấy các chỉ số như Pretax Profit Margin, Operating Profit Margin, Debt Equity Ratio và Current Ratio có ảnh hưởng lớn đến kết quả xếp hạng, phù hợp với lý thuyết phân tích tín dụng và góp phần nâng cao tính minh bạch của hệ thống. Trong tương lai, nghiên cứu có thể được mở rộng bằng cách bổ sung thêm dữ liệu phi tài chính như tin tức, báo cáo thường niên, dữ liệu ngành và các yếu tố kinh tế vĩ mô. Đồng thời, cần cải thiện khả năng nhận diện nhóm Distressed và tối ưu thời gian huấn luyện để hệ thống có thể ứng dụng hiệu quả hơn trong thực tế.
