"""Replace the two-tier-loss-contract cell in tcn-baseline.ipynb with inlined losses.py.

How to Run: python scratch/inline_losses.py
Expected Output: tcn-baseline.ipynb updated with inlined loss module.
"""
import json
from pathlib import Path

NOTEBOOK = Path(__file__).resolve().parent.parent / "notebooks" / "tcn-baseline.ipynb"
